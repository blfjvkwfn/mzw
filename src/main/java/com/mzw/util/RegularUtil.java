...
public class RegularUtil {
    ...
    /**
     * 密码规则 至少8位(字母+数字 字母+特殊字符 数字+特殊字符)组合
     */
    private static final String PASSWORD_PATTERN = "^(?![a-zA-z]+$)(?!\\d+$)(?![!@#$%^&*]+$)[a-zA-Z\\d!@#$%^&*]{8,}$";
    /**
     * 身份证正则
     */
    private static final String IDCARD_PATTERN = "(^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$)|(^[1-9]\\d{5}\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{2}$)";
    ...
    public static boolean isIdcart(String str) {
        return match(IDCARD_PATTERN, str);
    }
    ...
    public static boolean checkPassword(String str) {
        return match(PASSWORD_PATTERN, str);
    }
